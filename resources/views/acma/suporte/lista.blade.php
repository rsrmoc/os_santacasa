            ...
            <div class="row">
                <div class="col-md-10 ">
                    ...
                    <div class="page-breadcrumb">
                        <ol class="breadcrumb">
                            <li><a href="{{ route('chamados-suporte') }}">{{ $request['nm_oficina'] ?? 'Relação' }}</a>
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="row" style="margin-left: 3px; margin-right: 3px;">
                ...
                <div class="panel info-box panel-white" style="margin: 10px; margin-left: 0px; margin-right: 0px;" >
                    <div class="panel-body" style="padding: 10px;">
                        <div class="info-box-stats">
                            ...
                            <span class="info-box-title">Classificadas</span>
                        </div>
                        <div class="info-box-icon">
                            <i class="glyphicon glyphicon-edit icon-bar-info"></i>
                        </div>
                        <div class="info-box-progress">
                            <div class="progress progress-xs progress-squared bs-n">
                ...
                <div class="panel info-box panel-white" style="margin: 10px; margin-left: 0px; margin-right: 0px;" >
                    <div class="panel-body" style="padding: 10px;">
                        <div class="info-box-stats">
                            ...
                            <span class="info-box-title">Aprazadas</span>
                        </div>
                        <div class="info-box-icon">
                            <i class="glyphicon glyphicon-calendar icon-bar-success"></i>
                        </div>
                        <div class="info-box-progress">
                            <div class="progress progress-xs progress-squared bs-n">
                ...
                <div class="panel info-box panel-white" style="margin: 10px; margin-left: 0px; margin-right: 0px;" >
                    <div class="panel-body" style="padding: 10px;">
                        <div class="info-box-stats">
                            ...
                            <span class="info-box-title">Até 5 Dias</span>
                        </div>
                        <div class="info-box-icon">
                            <i class="glyphicon glyphicon-exclamation-sign icon-bar-warning"></i>
                        </div>
                        <div class="info-box-progress">
                            <div class="progress progress-xs progress-squared bs-n">
                ...
                <div class="panel info-box panel-white" style="margin: 10px; margin-left: 0px; margin-right: 0px;" >
                    <div class="panel-body" style="padding: 10px;">
                        <div class="info-box-stats">
                            ...
                            <span class="info-box-title">Entre 5 e 10 Dias</span>
                        </div>
                        <div class="info-box-icon">
                            <i class="glyphicon glyphicon-warning-sign  icon-bar-alert"></i>
                        </div>
                        <div class="info-box-progress">
                            <div class="progress progress-xs progress-squared bs-n">
                                <div class="progress-bar progress-bar-alert" role="progressbar" aria-valuenow="60"
            ...
            <div class="col-lg-2 col-md-4" style="padding-right: 3px; padding-left: 3px;">
                <div class="panel info-box panel-white" style="margin: 10px; margin-left: 0px; margin-right: 0px;" >
                    <div class="panel-body" style="padding: 10px;">
                        <div class="info-box-stats">
                            <p class="counter" x-html="header.card6"></p>
                            <span class="info-box-title">A mais de 10 Dias</span>
                        </div>
                        <div class="info-box-icon">
            ...
            <div class="panel panel-white" style="padding-bottom: 0px;">
                <div class="panel-heading" style="height: auto; padding-bottom: 0px;">
                    ...
                    <form x-on:submit.prevent="getPage()" class="panel panel-white" id="form-chamados"
                        ...
                        <input type="hidden" name="tp_pagina" value="suporte" />
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group @if ($errors->has('dti')) has-error @endif ">
                                    <input type="date" class="form-control"
                                        value="{{ old('dti', $request['dti']) }}" placeholder="Data Inicial"
                                        name="dti" required />
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group @if ($errors->has('dtf')) has-error @endif ">
                                    <input type="date" class="form-control"
                                        value="{{ old('dtf', $request['dtf']) }}" placeholder="Data Final"
                                        name="dtf" required />
                                </div>
                            </div>
                                    ...
                                    <tr x-bind:id="`tr-chamado-${os.cd_os}`">
                                        ...
                                        <td style="padding: 3px!important;">
                                            <span :class="(os.tab_classificacao?.class_prazo ?? 'bg-dias')"
                                                ...
                                                style="font-size: 80%; font-weight: 900; text-transform: none; "></span>
                                        </td>
