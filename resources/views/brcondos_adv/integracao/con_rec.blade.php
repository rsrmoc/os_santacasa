<x-layout.brcondos_adv.layout>
    <div class="page-title">
        ...
        <div class="page-breadcrumb">
            <ol class="breadcrumb">
                <li><a href="{{ route('usuarios-listar') }}">Contas a Receber</a></li>
            </ol>
        </div>
    </div>

    <div id="main-wrapper" x-data="appReceber">
        <div class="col-md-12 ">
            <form class="panel panel-white" x-on:submit.prevent="save" id="formReceber">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group @if($errors->has('nome')) has-error @endif ">
                                ...
                                <input type="text" class="form-control" value="{{old('nome')}}" placeholder="Nome" name="nome" x-model="inputs.nome" />
                                @if($errors->has('nome'))
    ...
    <x-slot name="scripts">
        <script src="{{ asset('/js/paginas/contas/receber.js') }}"></script>
    </x-slot>
</x-layout.brcondos_adv.layout>
