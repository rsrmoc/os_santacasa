<div class="navbar">
    ...
    <div class="navbar-inner">
        ...
        <div class="logo-box">
            <a href="#" class="logo-text"><img src="{{ asset('assets\images\logo_amaral.png') }}" style="width: 155px; height: 50px;   "></a> 
        </div><!-- Logo Box -->
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-list" role="menu"> 
                            <li role="presentation"><a href="{{ route('integracoes-con-rec')}}"><i class="fa fa-gear"></i>Contas a Receber</a></li>  
                           <!-- <li role="presentation"><a href="{{ route('integracoes-con-pag')}}"><i class="fa fa-gear"></i>Contas a Pagar</a></li> -->
                        </ul>
                    </li>
