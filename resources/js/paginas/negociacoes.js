Alpine.data('app', () => ({
    ...
    verDetalhes(boleto) {
        ...
        .then((res) => { 
            console.log(res);
            this.boletosAcordos = res.data.dados; 
            this.addAcordos = res.data.add; 
        })
    ...
    getBoletosAcordos(boleto,todos=null) {  
        this.loadingDetalhesBoletosAtrasados = true;
        this.boletosAcordos = [];  
        console.log(boleto);
        axios.get('/brcondos_adv/boleto-negoc-json', { 
        ...
        .then((res) => { 
            ...
            this.boletosAcordos = res.data.dados; 
            this.addAcordos = res.data.add; 
            this.inputBoletos.cd_boletos = res.data.select; 
        })
        .catch((error) => toastr['error'](error.response.data.message))
        .finally(() => this.loadingDetalhesBoletosAtrasados = false);
    ...
    salvarBoletos(){
        ...
        let data = Object.assign({}, this.inputBoletos);   
        console.log(data);
        axios.post('/brcondos_adv/boleto-negoc-store', data)
        .then((res) => { 
            toastr['success']('Salvo com sucesso');
            this.getBoletosAcordos(this.negocSelecionado); 
